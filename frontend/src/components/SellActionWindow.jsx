...
const SellActionWindow = ({onCancel , uid}) => {
  ...
  return (
    <div className='bg-white p-6 rounded-lg shadow-lg w-96 h-[300px] flex flex-col justify-between'>
        <div>
          <h2 className='text-xl font-semibold mb-4 text-gray-800'>Sell Order</h2>
        ...
        <div className='flex justify-end gap-3'>
            ...
            <Button className='bg-red-600 hover:bg-red-700 text-white' onClick={handleSell}>Sell</Button>
        </div>
    </div>
  )
}
