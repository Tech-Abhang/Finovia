      ...
      <div className="w-full flex">
        ...
        <div className="w-1/2 pl-5 pt-10">
          ...
          <div className="flex flex-col">
            <a href={tryDemo} className='text-blue-500 hover:underline py-1'>Try demo</a>
            <a href={learnMore} className='text-blue-500 hover:underline py-1'>Learn more</a>
          </div>

          <div className='flex gap-3 pt-3'>
            <a href={googlePlay}><img src='/appstoreBadge.svg'></img></a>
            <a href={appStore}><img src='/googlePlayBadge.svg'></img></a>
          </div>
        </div>
      </div>
    </div>
